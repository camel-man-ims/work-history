...
|날짜|요일|문제번호|성공 여부|도움|블로그 정리|분류|난이도|문제 유형|문제 이름| 스터디 공통 문제 |
| ------ | ------ | ------ | ------ | ------ | ------ |------ | ------ | ------ | ------ | ------ |
|22.01.01 | 토 | 1 | :x: | :white_check_mark: | |백준|| DFS/ 백트랙킹 | 괄호 추가하기 | :white_check_mark: |
|22.01.02 | 일 | 1 | :x: |  | |백준|| DFS/ 백트랙킹 | 괄호 추가하기 | :white_check_mark: |
|22.01.02 |  | 2 | :white_check_mark: | | |백준|| 다익스트라 | 파티 | :white_check_mark: |
